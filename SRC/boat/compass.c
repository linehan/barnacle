...
static cchar_t CBOR[2]; // One extra b/c the top is a different color
static cchar_t CMRK[3]; // Comprex characters to draw the ribbon

static WINDOW *inst_win, *cmpbox_win, *cmprib_win;   
static PANEL  *inst_pan, *cmpbox_pan, *cmprib_pan;
