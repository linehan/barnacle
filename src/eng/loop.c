/* 
 * loop.c -- Game loop 
 * The body of the main loop. It uses the libev event library
 * (http://software.schmorp.de/pkg/libev.html) to execute callback
 * functions at certain times, or on certain events (such as availible
 * keyboard input).
 * 
