...
//static const char *palette_name[NRAMPS]={ 
        //"Spectral 03",
        //"Spectral 04",
        //"Spectral 05",
        //"Spectral 06",
...
//static const int ramplen[NRAMPS]={3, 4, 5, 6,  7,  8,  9, 10, 11, 3, 4, 5,
                                  //6, 7, 8, 9, 10, 11, 29, 11, 32, 3, 4, 5, 
                                  //6, 7, 8, 9, 25,  7, 11, 11, 12, 3, 4, 5, 
                                  //6, 7, 8, 9, 10, 11, 24, 18, 19, 6, 11};
 ...
 *
 */
//static const uint32_t ramp[NRAMPS][MAXRAMPLEN][RGB]={
        //{   [> Spectral 3 <] 
            //{ 988,  553,  349}, 
            //{1000, 1000,  749}, 
            //{ 600,  835,  580}},
...
//#define TRIPLET(id, co) \
        //ramp[id][co][_R_], ramp[id][co][_G_], ramp[id][co][_B_]

#define TRIPLET(id, co) \
        ramp[id].rgb[co][_R_], ramp[id].rgb[co][_G_], ramp[id].rgb[co][_B_]
